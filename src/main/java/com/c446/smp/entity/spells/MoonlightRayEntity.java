...
public class MoonlightRayEntity extends Projectile implements AntiMagicSusceptible {
    ...
    public MoonlightRayEntity(EntityType<? extends BloodSlashProjectile> entityType, Level level) {
    ...
    public MoonlightRayEntity(EntityType<? extends BloodSlashProjectile> entityType, Level levelIn, LivingEntity shooter) {

...
import static com.c446.ironbound_core.registry.IronboundCoreAttributes.*;
    ...
    static {
        ...
        HOLLOW = EFFECTS.register("hollow", () -> {
            return new IronboundCoreEffect(MobEffectCategory.BENEFICIAL, rgbToInt(255, 90, 255)) {
                public void addAttributeModifiers(@NotNull LivingEntity pLivingEntity, @NotNull AttributeMap pAttributeMap, int pAmplifier) {
                    this.getAttributeModifiers().put(ENDER_SPELL_POWER.get(), new AttributeModifier(uuid3, this::getDescriptionId, getDamageBoost(pAmplifier), AttributeModifier.Operation.MULTIPLY_BASE));
                    this.getAttributeModifiers().put(FOCUS_ATTRIBUTE.get(), new AttributeModifier(uuid3, this::getDescriptionId, getResBoost(pAmplifier), AttributeModifier.Operation.MULTIPLY_BASE));
                    super.addAttributeModifiers(pLivingEntity, pAttributeMap, pAmplifier);
                }
            };
        });
        FERVOR = EFFECTS.register("radiant", () -> {
            return new IronboundCoreEffect(MobEffectCategory.BENEFICIAL, rgbToInt(255, 90, 255)) {
                public void addAttributeModifiers(@NotNull LivingEntity pLivingEntity, @NotNull AttributeMap pAttributeMap, int pAmplifier) {
                    this.getAttributeModifiers().put(HOLY_SPELL_POWER.get(), new AttributeModifier(uuid4, this::getDescriptionId, getDamageBoost(pAmplifier), AttributeModifier.Operation.MULTIPLY_BASE));
                    this.getAttributeModifiers().put(UNDEAD_DAMAGE.get(), new AttributeModifier(uuid4, this::getDescriptionId, getResBoost(pAmplifier), AttributeModifier.Operation.MULTIPLY_BASE));
                    super.addAttributeModifiers(pLivingEntity, pAttributeMap, pAmplifier);
                }
            };
        });
        FROSTED_EFFECT = EFFECTS.register("frosted", () -> {
            return new IronboundCoreEffect(MobEffectCategory.HARMFUL, rgbToInt(0, 90, 255)) {
                public void addAttributeModifiers(@NotNull LivingEntity pLivingEntity, @NotNull AttributeMap pAttributeMap, int pAmplifier) {
                    this.getAttributeModifiers().put(SPELL_RESIST.get(), new AttributeModifier(uuid5, this::getDescriptionId, getResReduction(pAmplifier), AttributeModifier.Operation.MULTIPLY_BASE));
                    this.getAttributeModifiers().put(FIRE_SPELL_POWER.get(), new AttributeModifier(uuid5, this::getDescriptionId, getDamageReduction(pAmplifier), AttributeModifier.Operation.MULTIPLY_BASE));
                    super.addAttributeModifiers(pLivingEntity, pAttributeMap, pAmplifier);
                }
            };
        });
        ...
        STRONG_MIND = EFFECTS.register("strong_mind", () -> {
            return new IronboundCoreEffect(MobEffectCategory.BENEFICIAL, 8080895) {
                public void addAttributeModifiers(@NotNull LivingEntity pLivingEntity, @NotNull AttributeMap pAttributeMap, int pAmplifier) {
                    AttributeModifier modifier = new AttributeModifier(uuid8, this::getDescriptionId, 0.1 + pAmplifier / 3, AttributeModifier.Operation.MULTIPLY_BASE);
                    Attribute attribute = FOCUS_ATTRIBUTE.get();
                    this.getAttributeModifiers().put(attribute, modifier);
                    super.addAttributeModifiers(pLivingEntity, pAttributeMap, pAmplifier);
                }
            };
        });
        ...
        MADNESS = EFFECTS.register("madness", () -> {
            return new IronboundCoreEffect(MobEffectCategory.HARMFUL, rgbToInt(120, 90, 0)) {
                public void addAttributeModifiers(@NotNull LivingEntity pLivingEntity, @NotNull AttributeMap pAttributeMap, int pAmplifier) {
                    AttributeModifier eldritchPowerMod = new AttributeModifier(uuid10, this::getDescriptionId, 0.5 + pAmplifier / 2, MULTIPLY_BASE);
                    AttributeModifier enderPowerMod = new AttributeModifier(uuid10, this::getDescriptionId, 0.5 + (pAmplifier / 2), MULTIPLY_BASE);
                    AttributeModifier maxHealthMod = new AttributeModifier(uuid10, this::getDescriptionId, (-0.1 + pAmplifier / 25), MULTIPLY_BASE);
                    this.getAttributeModifiers().put(ELDRITCH_SPELL_POWER.get(), eldritchPowerMod);
                    this.getAttributeModifiers().put(ENDER_SPELL_POWER.get(), enderPowerMod);
                    this.getAttributeModifiers().put(MAX_HEALTH, maxHealthMod);
                    super.addAttributeModifiers(pLivingEntity, pAttributeMap, pAmplifier);
                }
            };
        });
